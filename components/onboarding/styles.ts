...
import { type ThemeDefinition, radius as radiusScale, spacing as spacingScale } from '@/theme';

const serifFamily = Platform.select({ ios: 'Times New Roman', android: 'serif', default: 'serif' });
const sansFamily = Platform.select({ ios: 'System', android: 'sans-serif', default: 'System' });

const createOnboardingStyles = (theme: ThemeDefinition) => {
  ...
  return { styles, accentColor, colors };
};

export { createOnboardingStyles, radiusScale, spacingScale };
